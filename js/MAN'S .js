...
const HIDDEN_PRODUCTS_KEY = 'hiddenProducts_MANS'; // Changed key to be collection-specific
    ...
    document.querySelectorAll('.product-edit').forEach(editIcon => {
        editIcon.addEventListener('click', function(e) {
            ...
            overlay.querySelector('.save-edit-btn').addEventListener('click', function() {
                ...
                const productId = productCard.querySelector('.select-checkbox').id;
                const editedProducts = JSON.parse(localStorage.getItem('editedProducts_MANS') || '{}');
                ...
                localStorage.setItem('editedProducts_MANS', JSON.stringify(editedProducts));
